...
const MOCK_EVENTS = [
  {
    ...
    description: "A 48-hour hackathon focused on building solutions for campus life. Food, swag, and prizes included! Join hundreds of developers.",
    date: "2026-05-15T09:00:00Z",
    location: "Main Auditorium",
    category: "Technical",
    image_url: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=1740&auto=format&fit=crop",
    attendees_count: 120
  },
  {
    id: "2",
    title: "Cultural Night: Symphony",
    description: "Annual cultural festival featuring music, dance, and art exhibitions. Don't miss the flagship performance by the college band.",
    date: "2026-05-20T18:00:00Z",
    location: "Open Air Theatre",
    category: "Cultural",
    image_url: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=1674&auto=format&fit=crop",
    attendees_count: 350
  },
  {
    id: "3",
    title: "Inter-department Basketball",
    description: "Cheer for your department in the ultimate basketball showdown. Semi-finals and finals happening today. Get ready to witness history.",
    date: "2026-05-22T16:00:00Z",
    location: "Indoor Sports Complex",
    category: "Sports",
    image_url: "https://images.unsplash.com/photo-1546519638-68e109498ffc?q=80&w=1780&auto=format&fit=crop",
    attendees_count: 85
  }
];
      ...
      <div className="flex-1 max-w-6xl w-full mx-auto px-6 pt-32 pb-20 relative z-10 flex flex-col">
        <div className="max-w-2xl mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
            Your single source of truth for all campus activities. Ditch the WhatsApp noise and scattered announcements. Find, register, and check-in to events seamlessly.
          </p>
        </div>

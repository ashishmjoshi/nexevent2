      ...
      {events.map((evt) => (
        ...
        >
          <div className="aspect-[4/3] w-full overflow-hidden relative">
            ...
            <img 
              src={evt.image_url || "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=1740&auto=format&fit=crop"} 
              alt={evt.title}
            ...
            <div className="absolute bottom-4 left-4 z-20 flex flex-col gap-1">
              <span className="text-white/90 text-sm font-medium flex items-center gap-1.5">
                ...
                {new Date(evt.date).toLocaleDateString('en-US', { month: 'short', day: 'numeric', hour: 'numeric', minute: '2-digit' })}
              </span>
            </div>
          </div>
